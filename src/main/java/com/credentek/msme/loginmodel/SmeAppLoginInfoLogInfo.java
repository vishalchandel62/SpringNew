...
@Entity
@Table(name = "SME_APP_LOGIN_INFO_LOG_INFO", schema = "YES_SME1")
public class SmeAppLoginInfoLogInfo {
	...
	public String getIsmdmsearchflag1() {
		return ismdmsearchflag1;
	}

	public void setIsmdmsearchflag1(String ismdmsearchflag1) {
		this.ismdmsearchflag1 = ismdmsearchflag1;
	}
    ...
    @Column(name = "ISMDMSEARCHFLAG1", length = 1)
    private String ismdmsearchflag1 = "N"; // Default value
